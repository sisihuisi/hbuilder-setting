...
snippet t(:plugin_animation) do |s|
  ...
  snippet "navigator判断IE浏览器;" do |s|
  s.trigger = "naavigator"
  s.expansion = 'if(navigator.userAgent.indexOf(\'MSIE 6.0\')>0||navigator.userAgent.indexOf(\'MSIE 7.0\')>0||navigator.userAgent.indexOf(\'MSIE 8.0\')>0){return};'
  end
